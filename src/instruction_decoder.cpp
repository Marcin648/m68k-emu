...
std::vector<MaskTableElement> opcode_mask_table = {
    ...
    // {0xFF00, 0x6000, INSTRUCTION::Bra::create},        //(0b1111111100000000, 0b0110000000000000, "Bra")
    // {0xFF00, 0x6100, INSTRUCTION::Bsr::create},        //(0b1111111100000000, 0b0110000100000000, "Bsr")
    ...
    // {0xF1C0, 0x81C0, INSTRUCTION::Divs::create},       //(0b1111000111000000, 0b1000000111000000, "Divs")
    // {0xF0C0, 0x90C0, INSTRUCTION::Suba::create},       //(0b1111000011000000, 0b1001000011000000, "Suba")
    // {0xF1C0, 0xC0C0, INSTRUCTION::Mulu::create},       //(0b1111000111000000, 0b1100000011000000, "Mulu")
    // {0xF1C0, 0xC1C0, INSTRUCTION::Muls::create},       //(0b1111000111000000, 0b1100000111000000, "Muls")
...
AddressingMode InstructionDecoder::getAddressingMode(uint16_t part_mode, uint16_t part_reg){
